...
public class PAMVmAllocationPolicyChipAwareSimpleBestFit extends PAMVmAllocationPolicy{
	...
	public PAMVmAllocationPolicyChipAwareSimpleBestFit(List<? extends PAMHost> list) {
		super(list);
