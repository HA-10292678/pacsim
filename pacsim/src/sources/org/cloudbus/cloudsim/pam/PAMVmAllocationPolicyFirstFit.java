...
public class PAMVmAllocationPolicyFirstFit extends PAMVmAllocationPolicy {
	 ...
	 * @post $none
	 */
	public PAMVmAllocationPolicyFirstFit(List<? extends PAMHost> list) {
		super(list);
