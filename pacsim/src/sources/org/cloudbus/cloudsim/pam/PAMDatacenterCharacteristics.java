...
public class PAMDatacenterCharacteristics {
	 ...
	 * @post $none
	 */
	public PAMDatacenterCharacteristics(
			String architecture,
			String os,
			String vmm,
			List<? extends PAMHost> hostList,
			double timeZone,
			double costPerSec,
			double costPerMem,
     ...
     * @post $none
     */
    public PAMHost getHostWithFreePe() {
        return PAMHostList.getHostWithFreePe(getHostList());
    }
     ...
     * @post $none
     */
    public PAMHost getHostWithFreePe(int peNumber) {
        return PAMHostList.getHostWithFreePe(getHostList(), peNumber);
    }
	...
	public int getMipsOfOnePe() {
        ...
        return PAMPeList.getMips((List<PAMPe>) getHostList().get(0).getChipList().get(0).getPeList(), 0);
    }
     ...
     */
    @SuppressWarnings("unchecked")
	public int getMipsOfOnePe(int id, int chipId,int peId) {
        if (getHostList().size() == 0) {
            return -1;
        }
        List<Chip> chipList=(List<Chip>) PAMHostList.getById(getHostList(), id).getChipList();
        return PAMPeList.getMips((List<PAMPe>) ChipList.getById(chipList, chipId).getPeList(), peId);
    }
    ...
    public int getMips() {
        ...
        switch (getAllocationPolicy()) {
            ...
            case DatacenterCharacteristics.OTHER_POLICY_SAME_RATING:
                mips = getMipsOfOnePe() * PAMHostList.getPesNumber(getHostList());
                break;
    ...
    public int getPesNumber() {
        return PAMHostList.getPesNumber(getHostList());
    }
    ...
    public int getFreePesNumber() {
        return PAMHostList.getFreePesNumber(getHostList());
    }
    ...
    public int getBusyPesNumber() {
        return PAMHostList.getBusyPesNumber(getHostList());
    }
     ...
     * @post $none
     */
    public boolean setPeStatus(int status, int hostId, int chipId, int peId) {
        return PAMHostList.setPeStatus(getHostList(), status, hostId, chipId,peId);
    }
	 ...
	 */
	protected <T extends PAMHost> void setHostList(List<T> hostList) {
