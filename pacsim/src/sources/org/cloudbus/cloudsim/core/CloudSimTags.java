...
//    public static final double FNB_DROPPING_DELAY = 0.01; // 10 milliseconds
	...
	public static final int DCMANAGER_RUN = BASE + 43;

	public static final int DCMANAGER_START = BASE + 44;

	public static final int BROKER_START = BASE + 45;
	
	public static final int RB_SUBMIT_VM = BASE + 46;

	public static final int CONTACT_DCMANAGER = BASE + 47;
	
	public static final int SUBMIT_LIST = BASE + 48;
	
	public static final int POWER_SAVED = BASE + 49;

	public static final int PREDICTION_ALGORITHM = BASE + 50;

	public static final int DYNAMIC_SCHEDULING = BASE + 51;
