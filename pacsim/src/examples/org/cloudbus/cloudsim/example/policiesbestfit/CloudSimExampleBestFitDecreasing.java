package org.cloudbus.cloudsim.example.policiesbestfit;
...
import org.cloudbus.cloudsim.pam.PAMVmSchedulerBestFit;
...
public static void main(String args[]){
	...
	try {
		...
		PAMDatacenterBrokerExtended pamDBE=new PAMDatacenterBrokerExtended("PAMDatacenterBrokerExtended","workloadpattern_100");
 ...
 // need to store Pe id and MIPS Rating
	...
	hostList.add(
		new PAMHost(
			...
			storage,
			chipList,
			new PAMVmSchedulerBestFit(chipList),
			hostState
		)
	);
	} // This is our machine
