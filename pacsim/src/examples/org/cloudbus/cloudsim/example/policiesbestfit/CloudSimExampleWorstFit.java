...
public class CloudSimExampleWorstFit {
	
public static void main(String args[]){
	Log.printLine("Starting CloudSimExampleWorstFit...");
	...
	try {
		...
		CloudSimExampleWorstFit csps=new CloudSimExampleWorstFit();
		...
		Log.printLine("CloudSimExampleWorstFit finished!");
	}
	catch (Exception e) {
		e.printStackTrace();
