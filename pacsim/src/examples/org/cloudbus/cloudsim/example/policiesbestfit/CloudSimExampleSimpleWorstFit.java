...
import org.cloudbus.cloudsim.pam.PAMVmAllocationPolicySimpleWorstFit;
...
public class CloudSimExampleSimpleWorstFit {
	
public static void main(String args[]){
	Log.printLine("Starting CloudSimExampleSimpleWorstFit...");
	...
	try {
		...
		CloudSimExampleSimpleWorstFit csps=new CloudSimExampleSimpleWorstFit();
		...
		Log.printLine("CloudSimExampleSimpleWorstFit finished!");
	}
	catch (Exception e) {
		e.printStackTrace();
...
private  PAMDatacenter createDatacenter(String name) {
 ...
 // need to store Pe id and MIPS Rating
	...
	try {
		datacenter = new PAMDatacenter(name, characteristics, new PAMVmAllocationPolicySimpleWorstFit(hostList), storageList, 0);
	} catch (Exception e) {
		e.printStackTrace();
	}
