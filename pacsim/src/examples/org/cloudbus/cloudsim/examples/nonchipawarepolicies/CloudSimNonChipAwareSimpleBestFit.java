...
public class CloudSimNonChipAwareSimpleBestFit {
	
public static void main(String args[]){
	Log.printLine("Starting CloudSimNonChipAwareSimpleBestFit...");
	...
	try {
		...
		CloudSimNonChipAwareSimpleBestFit csps=new CloudSimNonChipAwareSimpleBestFit();
		...
		Log.printLine("CloudSimNonChipAwareSimpleBestFit finished!");
	}
	catch (Exception e) {
		e.printStackTrace();
