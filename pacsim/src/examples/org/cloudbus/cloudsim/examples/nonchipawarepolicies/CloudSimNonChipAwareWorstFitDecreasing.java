...
public class CloudSimNonChipAwareWorstFitDecreasing {
...
public static void main(String args[]){
	Log.printLine("Starting CloudSimNonChipAwareWorstFitDecreasing ...");
	...
	try {
		...
		CloudSimNonChipAwareWorstFitDecreasing csps=new CloudSimNonChipAwareWorstFitDecreasing();
		...
		Log.printLine("CloudSimNonChipAwareWorstFitDecreasing finished!");
	}
	catch (Exception e) {
		e.printStackTrace();
