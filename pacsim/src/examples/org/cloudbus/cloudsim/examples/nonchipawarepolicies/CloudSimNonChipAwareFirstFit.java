...
public class CloudSimNonChipAwareFirstFit {
	
public static void main(String args[]){
	Log.printLine("Starting CloudSimNonChipAwareFirstFit...");
	...
	try {
		...
		CloudSimNonChipAwareFirstFit csps=new CloudSimNonChipAwareFirstFit();
		...
		Log.printLine("CloudSimNonChipAwareFirstFit finished!");
	}
	catch (Exception e) {
		e.printStackTrace();
