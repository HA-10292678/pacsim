...
public class CloudSimNonChipAwareBestFitDecreasing {
	
public static void main(String args[]){
	Log.printLine("Starting CloudSimNonChipAwareBestFitDecreasing...");
	...
	try {
		...
		CloudSimNonChipAwareBestFitDecreasing csps=new CloudSimNonChipAwareBestFitDecreasing();
		...
		Log.printLine("CloudSimNonChipAwareBestFitDecreasing finished!");
	}
	catch (Exception e) {
		e.printStackTrace();
