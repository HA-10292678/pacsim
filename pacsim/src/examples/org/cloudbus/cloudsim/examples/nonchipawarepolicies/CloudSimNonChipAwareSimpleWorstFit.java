...
public class CloudSimNonChipAwareSimpleWorstFit {
	
public static void main(String args[]){
	Log.printLine("Starting CloudSimNonChipAwareSimpleWorstFit...");
	...
	try {
		...
		CloudSimNonChipAwareSimpleWorstFit csps=new CloudSimNonChipAwareSimpleWorstFit();
		...
		Log.printLine("CloudSimNonChipAwareSimpleWorstFit finished!");
	}
	catch (Exception e) {
		e.printStackTrace();
