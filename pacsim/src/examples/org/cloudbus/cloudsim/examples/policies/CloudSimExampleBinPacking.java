...
public class CloudSimExampleBinPacking {
...
public static void main(String args[]){
	Log.printLine("Starting CloudSimExampleBinPacking ...");
	...
	try {
		...
		CloudSimExampleBinPacking csps=new CloudSimExampleBinPacking();
		...
		@SuppressWarnings("unused")
		PAMDatacenterBrokerExtended pamDBE=new PAMDatacenterBrokerExtended("PAMDatacenterBrokerExtended","workloadpattern_2");
		...
		Log.printLine("CloudSimExampleBinPacking finished!");
	}
	catch (Exception e) {
		e.printStackTrace();
