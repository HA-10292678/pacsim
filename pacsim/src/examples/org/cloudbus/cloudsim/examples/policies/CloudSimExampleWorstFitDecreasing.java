...
* @author		Srinivasan.S
* @version		CS 1.0
* Example using PAMVmAllocationPolicySBF
*/

public class CloudSimExampleWorstFitDecreasing {
...
public static void main(String args[]){
	Log.printLine("Starting CloudSimExampleWorstFitDecreasing ...");
	...
	try {
		...
		CloudSimExampleWorstFitDecreasing csps=new CloudSimExampleWorstFitDecreasing();
		PAMDatacenter datacenter0 = csps.createDatacenter("Datacenter_0");
		//csps.createDCManager(datacenter0);
		DCManager dcManager=new DCManager("DCManager_0",datacenter0);
		dcManager.sortVm(desc);
		...
		Log.printLine("CloudSimExampleWorstFitDecreasing finished!");
	}
	catch (Exception e) {
		e.printStackTrace();
