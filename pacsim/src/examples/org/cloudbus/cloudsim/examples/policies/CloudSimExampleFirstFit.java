...
import org.cloudbus.cloudsim.pam.PAMVmAllocationPolicyFirstFit;
...
public class CloudSimExampleFirstFit {
	
public static void main(String args[]){
	Log.printLine("Starting CloudSimExampleFirstFit...");
	...
	try {
		...
		CloudSimExampleFirstFit csps=new CloudSimExampleFirstFit();
		...
		Log.printLine("CloudSimExampleFirstFit finished!");
	}
	catch (Exception e) {
		e.printStackTrace();
...
private  PAMDatacenter createDatacenter(String name) {
 ...
 // need to store Pe id and MIPS Rating
	...
	try {
		datacenter = new PAMDatacenter(name, characteristics, new PAMVmAllocationPolicyFirstFit(hostList), storageList, 0);
	} catch (Exception e) {
		e.printStackTrace();
	}
