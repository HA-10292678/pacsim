...
import org.cloudbus.cloudsim.pam.PAMVmAllocationPolicyBestFit;
...
public class CloudSimExampleBestFit {
	
public static void main(String args[]){
	Log.printLine("Starting CloudSimExampleBestFit...");
	...
	try {
		...
		CloudSimExampleBestFit csps=new CloudSimExampleBestFit();
		...
		Log.printLine("CloudSimExampleBestFit finished!");
	}
	catch (Exception e) {
		e.printStackTrace();
...
private  PAMDatacenter createDatacenter(String name) {
 ...
 // need to store Pe id and MIPS Rating
	...
	try {
		datacenter = new PAMDatacenter(name, characteristics, new PAMVmAllocationPolicyBestFit(hostList), storageList, 0);
	} catch (Exception e) {
		e.printStackTrace();
	}
